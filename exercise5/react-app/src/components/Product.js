            ...
            <div>
                <div className = {styles.header}>
                    ...
                    <div className = {styles.imageContainer}>
                        <img className = {styles.img} src={props.data.IMG} alt="No image here"/>
                    </div>
                ...
                <div className = {styles.rating}>
                    {props.data.RatingCount ? <><img className = {styles.ratingIMG} src={`/images/${props.data.RatingIMG}`} alt="No review here!"/> 
